      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-brand flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="mt-6 text-white/70 text-base leading-relaxed max-w-sm">
            We'll send a secure link to your email address so you can choose a new password.
          </p>
        </div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          {submitted ? (
            <div>
              ...
              <h2 className="text-2xl font-extrabold text-navy-500">Check your email</h2>
              <p className="mt-2 text-sm text-navy-500/60 leading-relaxed">
                If an account exists for <span className="font-semibold text-navy-500">{email}</span>, we've sent a password reset link. Check your inbox (and spam folder).
              </p>
              <Link
                to="/login"
            ...
            <>
              <h2 className="text-2xl font-extrabold text-navy-500">Forgot your password?</h2>
              <p className="mt-1 text-sm text-navy-500/50">Enter your email and we'll send you a reset link.</p>
              ...
              <form onSubmit={handleSubmit} className="mt-8 space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full border-2 border-purple-100 rounded-xl px-4 py-3 text-base text-navy-500 bg-white focus:outline-none focus:border-pink-500 transition-colors placeholder:text-navy-500/30"
                  />
                </div>
